...
\boldmath
\usepackage[orientation=landscape,size=custom,width=106.68,height=81.28,scale=1.165,debug]{beamerposter}
...
\begin{columns}
  ...
  \begin{block}{High-Throughput Sequencing at the NCFAD Genomics Unit}
    ...
    \vskip1.0ex
    \includegraphics[width=1.0\linewidth]{seq-over-time-plot/seq-over-time.pdf}
    \end{column}
    ...
    \begin{columns}
      \begin{column}{0.7\textwidth}
        ...
        \begin{itemize}
          ...
          % \end{itemize}
          \item Investigation of infectious disease and mortality events in farmed animals, terrestrial and marine wildlife
          % \begin{itemize}
          ...
          \item Regular national and international wet- and dry-lab exercises
          \begin{itemize}
          ...
          \end{itemize}
          \item \textbf{Novel virus discovery and publication:}
        \end{itemize}
        % \vskip0ex
        \begin{tabular}{c l}
            % & \textbf{Novel Virus Discovery Publications} \\
            % Senecavirus cetus
            \vtop{\null\hbox{
            ...
            % &
            % \vtop{\null\hbox{
            % \qrcode[height=40pt]{https://www.nature.com/articles/s44298-024-00040-6} 
            % }}
            ...
            \vtop{\null\hbox{
            \parbox[t]{.85\textwidth}{
            Genome organization of \textbf{Canada goose coronavirus CB17},
